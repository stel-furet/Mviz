...
- **Storm Plugin Performance**: Storm plugin is too CPU intensive and runs too slow - needs optimization, REPLACE AS THE EXAMPLE IN DOCS
...
- Nebula needs to NOT have Audio Reactivity affect tentacles by defualt
...
- While the Mixer is closed, teh V Hot key needs to be made inactive
...
- Comment All Plugin Code properly
