/**
 * Cyber Tunnel - Retro 80s/90s Arcade Visualizer
 * 
...
class CyberTunnelPlugin extends FrequePluginBase {
    constructor(visualizer) {
        super('cybertunnel', visualizer, {
            version: '1.0.0',
            author: 'Steve - CrashMonkeys',
    ...
    onInitialize() {
        console.log('Cyber Tunnel plugin initialized');
    ...
    onCleanup() {
        console.log('Cyber Tunnel plugin cleaned up');
    }
}
...
setTimeout(() => {
    if (window.visualizer && window.FrequePluginBase) {
        new CyberTunnelPlugin(window.visualizer);
        console.log('🎮 Cyber Tunnel plugin loaded!');
    }
}, 500);
